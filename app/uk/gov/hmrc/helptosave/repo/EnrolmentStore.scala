...
trait EnrolmentStore {
  ...
  def insert(nino: NINO, itmpFlag: Boolean, eligibilityReason: Option[Int], source: String, accountNumber: String)(implicit hc: HeaderCarrier): EitherT[Future, String, Unit]
...
class MongoEnrolmentStore @Inject() (mongo:   ReactiveMongoComponent,
  ...
  private[repo] def doInsert(nino:              NINO,
                             ...
                             source:            String,
                             itmpFlag:          Boolean,
                             accountNumber:     String)(implicit ec: ExecutionContext): Future[WriteResult] =
  ...
  override def insert(nino:              NINO,
                      ...
                      eligibilityReason: Option[Int],
                      source:            String,
                      accountNumber:     String)(implicit hc: HeaderCarrier): EitherT[Future, String, Unit] =
    EitherT(
